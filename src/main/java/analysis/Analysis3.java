...
/**
 * This class defines the analysis for analysis type Ratio of CO2 Emissions and GDP per Capita (current US$). This class is a subclass of class AnalysisObject.
 * 
 * @author Henry So
 *
 */
