...
/**
 * This class defines the analysis for analysis type Ratio of Hospital Beds (per 1000) and Current Health Expenditure (per 1000). This class is a subclass of class AnalysisObject.
 * 
 * @author Henry So
 *
 */
public class Analysis6 extends AnalysisObject{
	//instance variables
	...
	public void calculate(SelectionObject select) {
		requiredStats = new String[] {"SH.MED.BEDS.ZS", "SH.XPD.CHEX.GD.ZS"};
