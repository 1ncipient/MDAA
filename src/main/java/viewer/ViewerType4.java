...
/**
 * Class allowing for scatter charts to be created
...
public class ViewerType4 implements ViewerCreation{
	...
	public ChartPanel createViewer(AnalysisObject analysis) {
		...
		//special check needed, due to unusual axis scaling for the particular analysis
		...
		//if 2 series or higher, add second y-axis
		if (data.length >= 2) {
